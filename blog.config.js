...
const BLOG = {
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,qq,weibo,email,facebook,twitter,telegram,messenger,reddit', // 分享的服務，按顺序显示,逗号隔开
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '这是开启新世界的网站', // 站点描述，被notion中的页面描述覆盖
