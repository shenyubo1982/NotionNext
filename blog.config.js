...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，欢迎🎉',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dao.mifuts.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'web3,cryptoCoin,vc', // 网站关键词 英文逗号隔开
