...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '欢迎，相见即是缘。🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ManMenDao', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '从一个人开始，向一群人出发。ManMen DAO由投研、技术、运营等领域的Web3实干家发起，以DAO的方式组织内容输出和产品实践，以稳健步伐，共赴硅基未来。🚀', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.mendao.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Web3,CryptoCoin,Hunter', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'mmendao@163.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/@manmendao', // Youtube主页
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,weibo,email,facebook,twitter,telegram,reddit', // 分享的服務，按顺序显示,逗号隔开
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || '4FHrhmZUiNSd2nNEVckmQ',
  // WebwhizAI 机器人 @see https://github.com/webwhiz-ai/webwhiz
  WEB_WHIZ_ENABLED: process.env.NEXT_PUBLIC_WEB_WHIZ_ENABLED || false, // 是否显示
  WEB_WHIZ_BASE_URL: process.env.NEXT_PUBLIC_WEB_WHIZ_BASE_URL || 'https://api.webwhiz.ai', // 可以自建服务器
  WEB_WHIZ_CHAT_BOT_ID: process.env.NEXT_PUBLIC_WEB_WHIZ_CHAT_BOT_ID || '65550c5fadef31f314881aec', // 在后台获取ID
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Web3 DAO BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '认知决定财富', // 站点描述，被notion中的页面描述覆盖
